...
module.exports = "<div class=\"jumbotron text-center\">\n    <h1>\n        MEAN Authentication App\n    </h1>\n    <p class=\"lead\">\n        Welcome to our custom MEAN stack authentication application built from scratch\n    </p>\n    <div>\n        <a [routerLink]=\"['/register']\" class=\"btn btn-primary\">Register</a>\n        <a [routerLink]=\"['/login']\" class=\"btn btn-default\">Login</a>\n    </div>\n</div>\n\n<div class=\"row\">\n    <div class=\"col-md-4\">\n        <h3>Express Backend</h3>\n        <p>A rock solid Node.js/Express server using Mongoose to orignize models and query the database</p>\n    </div>\n    <div class=\"col-md-4\">\n        <h3>Angular CLI</h3>\n        <p>Angular CLI to generate components, services and more. Local dev server and easy compilation</p>\n    </div>\n    <div class=\"col-md-4\">\n        <h3>JWT Tokens</h3>\n        <p>Full featured authentication using JSON web tokens. Login and store user data</p>\n    </div>\n</div>"
...
module.exports = "<div class=\"panel panel-default bodyCenter\">\n    <div class=\"panel-heading\">Login</div>\n    <form action=\"\" (submit)=\"onLoginSubmit()\">\n        <div class=\"panel-body\">\n            <div class=\"form-group\">\n                <label for=\"\">Username</label>\n                <input type=\"text\" name=\"username\" [(ngModel)]=\"username\" id=\"\" class=\"form-control\" />\n            </div>\n            <div class=\"form-group\">\n                <label for=\"\">Password</label>\n                <input type=\"password\" name=\"password\" [(ngModel)]=\"password\" id=\"\" class=\"form-control\" />\n            </div>\n        </div>\n        <div class=\"panel-footer\">\n            <input type=\"submit\" value=\"Submit\" class=\"btn btn-success\" />\n        </div>\n    </form>\n</div>"
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authUser(user).subscribe(function (data) {
            if (data.success) {
                // console.log(data);
                _this._flashMessagesService.show('Success Full Login...!', { cssClass: 'alert-success', timeout: 1000 });
                _this.authService.storeData(data.token, data.user);
                _this.router.navigate(['dashboard']);
            }
            else {
                _this._flashMessagesService.show(data.msg, { cssClass: 'alert-danger', timeout: 1000 });
...
module.exports = "<div class=\"panel panel-default bodyCenter\">\n    <div class=\"panel-heading\">Register</div>\n    <form action=\"\" (submit)=\"onRegisterSubmit()\">\n        <div class=\"panel-body\">\n            <div class=\"form-group\">\n                <label for=\"\">Name</label>\n                <input type=\"text\" name=\"name\" id=\"\" class=\"form-control\" [(ngModel)]=\"name\" />\n            </div>\n            <div class=\"form-group\">\n                <label for=\"\">Username</label>\n                <input type=\"text\" name=\"username\" [(ngModel)]=\"username\" id=\"\" class=\"form-control\" />\n            </div>\n            <div class=\"form-group\">\n                <label for=\"\">Email</label>\n                <input type=\"email\" name=\"email\" [(ngModel)]=\"email\" id=\"\" class=\"form-control\" />\n            </div>\n            <div class=\"form-group\">\n                <label for=\"\">Password</label>\n                <input type=\"password\" name=\"password\" [(ngModel)]=\"password\" id=\"\" class=\"form-control\" />\n            </div>\n        </div>\n        <div class=\"panel-footer\">\n            <input type=\"submit\" value=\"Submit\" class=\"btn btn-primary\" />\n        </div>\n    </form>\n</div>"
...
var RegisterComponent = (function () {
    function RegisterComponent(validateServices, authService, route, _flashMessagesService) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this._flashMessagesService.show('You are successfully register now continew with login...!', { cssClass: 'alert-success', timeout: 1000 });
                _this.route.navigate(['/login']);
            }
            else {
                _this._flashMessagesService.show('Oopss! Some Problem with registration. Try again...!', { cssClass: 'alert-danger', timeout: 1000 });
...
RegisterComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__Services_validate_service__["a" /* ValidateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__Services_validate_service__["a" /* ValidateService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__Services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__Services_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_angular2_flash_messages__["FlashMessagesService"]) === "function" && _d || Object])
], RegisterComponent);
...
/***/ "../../../../../src/app/Permission/authGard.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AuthService = (function () {
    ...
    AuthService.prototype.loadToken = function () {
        var cToken = localStorage.getItem('id_token');
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validataEmail = function (email) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Permission_authGard_service__ = __webpack_require__("../../../../../src/app/Permission/authGard.service.ts");
...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_10__Components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_14__Permission_authGard_service__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_11__Components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_14__Permission_authGard_service__["a" /* AuthGuard */]] }
];
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_12__Services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__Services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_14__Permission_authGard_service__["a" /* AuthGuard */]],
